...
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name my_bram

set_property -dict [list CONFIG.Component_Name {my_bram} CONFIG.Write_Width_A {6} CONFIG.Write_Depth_A {64} CONFIG.Read_Width_A {6}CONFIG.Write_Width_B {6} CONFIG.Write_Depth_B {64} CONFIG.Read_Width_B {6} CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex7/my_init.coe}] [get_ips my_bram]

set_property generate_synth_checkpoint false [get_files my_bram.xci]
reset_target all [get_ips my_bram]
